...
{ 
    ...
    async componentDidMount ()
    {
        ...
        const res = axios.get(`http://127.0.0.1:8000/api/pemeriksa/Editlaporan2/${idlaporan}`);
        // console.log(res);
        if((await res).data.stt === 200)
        {
            this.setState({
                id:(await res).data.sudahdftrku.id,
                nama_BUterdaftar:(await res).data.sudahdftrku.nama_BUterdaftar,
                alamat_BUterdaftar:(await res).data.sudahdftrku.alamat_BUterdaftar,
                notelp_BUterdaftar:(await res).data.sudahdftrku.notelp_BUterdaftar,
    ...
    updatelaporan = async (e)=> {
        ...
        const res = await axios.put(`http://127.0.0.1:8000/api/pemeriksa/Updatelaporan2/${idlaporan}` , this.state);
                        ...
                        <div class="card-header">
                            ...
                            <div className='card-body'>
                                ...
                                <table>
                                        ...
                                        <input type="text" name="nama_BUterdaftar" onChange={this.handleInput} value={this.state.nama_BUterdaftar} className="form-control" />
                                    </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <input type="text" name="alamat_BUterdaftar" onChange={this.handleInput} value={this.state.alamat_BUterdaftar} className="form-control" />
                                    </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <input type="text" name="notelp_BUterdaftar" onChange={this.handleInput} value={this.state.notelp_BUterdaftar} className="form-control" />
                                    </div>
                                            </td>
                                        </tr>
