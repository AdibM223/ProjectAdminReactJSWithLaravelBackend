...
class LimpahanLaporan5 extends Component 
{ 
    state = {
        kode_buterdaftar:'',
        tgl_pelimpahan:'',
        badan_pelimpah:'BU Menunggak Iuran',
        dasar_pelimpahan:'',
    }
    ...
    async componentDidMount ()
    {
        ...
        const res = axios.get(`http://127.0.0.1:8000/api/tunggakiuran/limpahkan/${idlaporan}`);
        console.log(res);
    ...
    Simpanlaporan = async (e)=> {
        ...
        const idlaporan = this.props.match.params.id;
        const res = await axios.put(`http://127.0.0.1:8000/api/tunggakiuran/limpahlaporan/${idlaporan}`,this.state);
        if (res.data.stt === 200)
        {
...
export default  withRouter(LimpahanLaporan5);